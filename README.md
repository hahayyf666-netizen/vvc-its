...
### PPA 优化版本 (UltraScale+ 500MHz)

| 版本 | Tag | 关键改动 | WNS | DSP | 功耗 | 测试 |
|------|-----|---------|-----|-----|------|------|
| **v1.2** | `v1.2` | P3: 移除 lfnst_out_buf 清零，LUT -3% | +0.083ns | 5 | 0.207W | 94/94 |
| **v1.1** | `v1.1` | P2: 行/列引擎复用，DSP -44%，功耗 -33% | +0.081ns | 5 | 0.214W | 94/94 |
| **v1.0** | `v1.0` | Baseline: 原始双引擎设计 | +0.031ns | 9 | 0.318W | 94/94 |
